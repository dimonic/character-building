...
<?php
  ...
  get_bonuses();
  echo "<h4>Base attack bonus = $attacks, Str bonus = " . get_att_bonus('str') . ", Dex bonus = " . get_att_bonus('dex') . "</h4>\n";
  ...
  for ($c = 1; $c <= 4; $c++) {
    ...
    echo "</td>\n<td>";
    form_input_number('characters', "weapon_{$c}_cost", $character["weapon_{$c}_cost"], 8);
    echo "</td>\n</tr>\n";
  }
?>
      </table>
...
<?php
  ...
  echo "</td>\n<td>";
  form_input_number('characters', 'armor_cost', $character[armor_cost], 8);
  echo "</td>\n";
?>
	</tr>
	<tr>
