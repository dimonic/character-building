...
<h3><a name="prior_experience">Prior Experience</a></h3>

<p>Characters do not start off in a vacuum, suddenly able only to
swing a sword or cast a spell. They grew up in an environment which
gave them some skills an abilities as they were raised. This is to be
reflected by taking one level worth of skills as an NPC character
class. You may also add the HP of this class to your starting
character. For example, you can choose to have gained some training as
an adept before starting out as an adventurer. You would gain 6 hit
points, and 2 + Int modifier skills from the adept skill list.</p>
