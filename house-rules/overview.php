...
<h3>What have we done?</h3>
  ...
  <p>We all love feats, and we feel that many classes don't get enough
  feats to really embrace some cool concepts that fit their class,
  style and background. Therefore, we are permitting a feat <em>every
  2 levels</em> instead of every third level. This means a feat at 1st
  and 3rd as usual, then 5th, 7th, 10th etc.) Note that fighters will
  therefore receive a feat <em>every level</em>! Since this only
  results in 1 extra feat by 7th level, we do not think this will
  change such things as prestige entry requirements very much.</p>

  <p>Additionally, we are also allowing one free <a
  href=../greyhawk/feats.php>regional feat</a> at first level, to be
  taken according to the character's region of origin.</p>
